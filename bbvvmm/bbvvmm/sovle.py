...
def _round_keys(mk):
    ...
    #_rk_keys = [0x78da27f844fdd1,0x11508c60fc86a8,0x424adbca3c9b78,0x1edff37133dadc,0x2d6f30b72f5731,0x646f38d17560d5,0x6a9ec9f150e4ad,0x47c478c16d51b7,0x654ac0925a0855,0x2acd03e72b4d73,0x6c607809a5a671,0x61673df68b5ba,0x7723b0becf17c0,0x4cd4e74b53dc65,0x1d0f96c282ec15,0x547c7686512b09,0x1b65c1b9383cbc,0x6dd7967009d87f,0xafb8629d9217a,0x490d14437c248b,0x1efc829bc5cfbe,0x5b8ef37683e1b6,0x54de5a1d64849f,0x68a31fa1fa382,0x4770760f09a64c,0x636d44915d5beb,0x621e68982b67bc,0x3825cf5fd2e1e6,0x4cd057e794f4f6,0x772696beb95357,0x45fd07fb3bcfc0,0x66505eb43dc7dd]
    #print _rk_keys
    return _rk_keys
...
if __name__ == '__main__':
	ct = int("3132333435360000".encode('hex'),16)
	m = 0xd60d29fd0b3a70a553b72a31daf198da
	ct = 0xEF468DBAF985B2509C9E200CF3525AB6
    #ct = 0xef468dbaf985b2509c9e200cf3525ab6
	#c = '123456'
	#m = '1234'
	print hex(encrypt(ct,m))
	##print encrypt_cbc(c,m,'1')
	#print encrypt_ecb(c,m)